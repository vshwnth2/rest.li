...
public class RestLiDataValidator
{
   ...
   */
  private class RestLiAnnotationDataValidator extends DataSchemaAnnotationValidator
  {
    private RestLiAnnotationDataValidator(DataSchema schema)
    {
  ...
  private ValidationResult validatePatch(PatchRequest<?> patchRequest)
  {
    ...
    return ValidateDataAgainstSchema.validate(new SimpleDataElement(entity.data(), entity.schema()),
        new ValidationOptions(RequiredMode.IGNORE), new RestLiAnnotationDataValidator(entity.schema()));
  }
  ...
  private ValidationResult validateInputEntity(RecordTemplate entity)
  {
    ...
    validationOptions.setTreatOptional(_readOnlyOptionalPredicate);
    return ValidateDataAgainstSchema.validate(entity, validationOptions, new RestLiAnnotationDataValidator(entity.schema()));
  }
