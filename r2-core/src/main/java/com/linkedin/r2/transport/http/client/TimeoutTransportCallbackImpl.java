...
public class TimeoutTransportCallbackImpl<T> implements TimeoutTransportCallback<T>
{
   ...
   *                       timeout occurs.
   */
  public TimeoutTransportCallbackImpl(ScheduledExecutorService scheduler,
                                      long timeout,
